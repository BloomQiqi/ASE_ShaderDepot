...
Shader "Landscape"
{
	Properties
	{
		...
		_AutoSlopeRange("AutoSlopeRange", Float) = 0
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_3_0_g5 = _Layer1_HeightContrast;
			float4 tex2DNode5 = tex2D( _Layer1_HRA, temp_output_8_0 );
			float lerpResult1_g5 = lerp( ( 0.0 - temp_output_3_0_g5 ) , ( temp_output_3_0_g5 + 1.0 ) , tex2DNode5.r);
			float clampResult2_g5 = clamp( lerpResult1_g5 , 0.0 , 1.0 );
			float Layer1_Height13 = clampResult2_g5;
			float2 uv2_BlendMask = i.uv2_texcoord2 * _BlendMask_ST.xy + _BlendMask_ST.zw;
			float4 break164 = tex2D( _BlendMask, uv2_BlendMask );
			...
			float temp_output_3_0_g10 = _Layer3_HeightContrast;
			float2 temp_output_38_0 = ( LayerUV4 * _Layer3Tilling );
			float4 tex2DNode41 = tex2D( _Layer3_HRA, temp_output_38_0 );
			float lerpResult1_g10 = lerp( ( 0.0 - temp_output_3_0_g10 ) , ( temp_output_3_0_g10 + 1.0 ) , tex2DNode41.r);
			float clampResult2_g10 = clamp( lerpResult1_g10 , 0.0 , 1.0 );
			float Layer3_Height44 = clampResult2_g10;
			...
			float temp_output_10_0_g12 = _SlopeContrast;
			float4 break211 = BlendWeight112;
			float HeightCombine222 = ( ( Layer1_Height13 * break211.x ) + ( Layer2_Height35 * break211.y ) + ( Layer3_Height44 * break211.z ) + ( Layer4_Height171 * break211.w ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float dotResult226 = dot( float3(0,1,0) , ase_worldNormal );
			float clampResult8_g12 = clamp( ( ( HeightCombine222 - 1.0 ) + ( pow( ( 1.0 - dotResult226 ) , _AutoSlopeRange ) * 2.0 ) ) , 0.0 , 1.0 );
			float lerpResult13_g12 = lerp( ( 0.0 - temp_output_10_0_g12 ) , ( temp_output_10_0_g12 + 1.0 ) , clampResult8_g12);
			float clampResult14_g12 = clamp( lerpResult13_g12 , 0.0 , 1.0 );
			float Slope230 = clampResult14_g12;
			float4 lerpResult236 = lerp( ( ( Layer1_BaseColor11 * break117.x ) + ( Layer2_BaseColor34 * break117.y ) + ( Layer3_BaseColor43 * break117.z ) + ( break117.w * Layer4_BaseColor176 ) ) , Layer2_BaseColor34 , Slope230);
			float4 BaseColor54 = lerpResult236;
			...
			float3 lerpResult245 = lerp( ( ( Layer1_Normal16 * break144.x ) + ( Layer2_Normal32 * break144.y ) + ( Layer3_Normal47 * break144.z ) + ( Layer4_Normal175 * break144.w ) ) , Layer2_Normal32 , Slope230);
			float3 Normal152 = lerpResult245;
			...
			float lerpResult239 = lerp( ( ( Layer1_Roughness14 * break122.x ) + ( Layer2_Roughness31 * break122.y ) + ( Layer3_Roughness45 * break122.z ) + ( break122.w * Layer4_Roughness174 ) ) , Layer2_Roughness31 , Slope230);
			float Roughness130 = lerpResult239;
			...
			float lerpResult242 = lerp( ( ( Layer1_AO15 * break133.x ) + ( Layer2_AO33 * break133.y ) + ( Layer3_AO46 * break133.z ) + ( break133.w * Layer4_AO177 ) ) , Layer2_AO33 , Slope230);
			float AO141 = lerpResult242;
			s1.Occlusion = AO141;
...
/*ASEBEGIN
Version=18500
289.3333;635.3334;1536;561;1530.714;-2486.524;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;206;-1487.54,-351.8077;Inherit;False;651.435;365.0983;LayerUI;3;4;3;208;LayerUI;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;3;-1437.54,-296.9094;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;207;-1357.777,-122.4031;Inherit;False;Constant;_Float1;Float 1;22;0;Create;True;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;208;-1185.777,-223.4031;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;4;-1035.905,-301.8077;Inherit;False;LayerUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-2356.627,243.1945;Inherit;False;Property;_Layer1Tilling;Layer1Tilling;2;0;Create;True;0;0;False;0;False;0;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-2346.076,1057.505;Inherit;False;Property;_Layer2Tilling;Layer2Tilling;7;0;Create;True;0;0;False;0;False;0;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;168;-2352.518,2568.921;Inherit;False;4;LayerUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;167;-2348.619,2652.421;Inherit;False;Property;_Layer4Tilling;Layer4Tilling;17;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-2351.386,1823.781;Inherit;False;Property;_Layer3Tilling;Layer3Tilling;12;0;Create;True;0;0;False;0;False;0;12;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;199;-1754.029,320.566;Inherit;False;Property;_Layer1_HeightContrast;Layer1_HeightContrast;3;0;Create;True;0;0;False;0;False;0;-0.885;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;201;-1710.951,1097.367;Inherit;False;Property;_Layer2_HeightContrast;Layer2_HeightContrast;8;0;Create;True;0;0;False;0;False;0;-0.457;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;163;-807.9973,2535.482;Inherit;False;1;162;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;205;-1729.475,2642.26;Inherit;False;Property;_Layer4_HeightContrast;Layer4_HeightContrast;18;0;Create;True;0;0;False;0;False;0;-0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;198;-1454,286;Inherit;False;CheapContrast;-1;;5;7235b5869aad1de43b58d5dfac7f22ee;0;2;7;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;200;-1439.412,1069.983;Inherit;False;CheapContrast;-1;;6;7235b5869aad1de43b58d5dfac7f22ee;0;2;7;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;203;-1704.04,1867.97;Inherit;False;Property;_Layer3_HeightContrast;Layer3_HeightContrast;13;0;Create;True;0;0;False;0;False;0;-0.285;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;13;-1193.716,302.2585;Inherit;False;Layer1_Height;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;204;-1460.434,2672.374;Inherit;False;CheapContrast;-1;;11;7235b5869aad1de43b58d5dfac7f22ee;0;2;7;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;202;-1424.305,1846.457;Inherit;False;CheapContrast;-1;;10;7235b5869aad1de43b58d5dfac7f22ee;0;2;7;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;162;-557.2496,2593.648;Inherit;True;Property;_BlendMask;BlendMask;0;0;Create;True;0;0;False;0;False;-1;None;3bd9874aba2131541bcb232ced7efc25;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BreakToComponentsNode;164;-258.4927,2804.928;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.GetLocalVarNode;160;52.50702,2839.778;Inherit;False;35;Layer2_Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;171;-1172.906,2678.024;Inherit;False;Layer4_Height;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;95;477.1345,3056.169;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;183;393.6824,3355.443;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;96;574.0136,3222.636;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;98;389.4987,3426.636;Inherit;False;Property;_BlendContrast;BlendContrast;1;0;Create;True;0;0;False;0;False;0;0.058;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;182;673.6824,3330.443;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;97;826.4988,3396.636;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;184;914.6824,3115.443;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;185;1078.682,3116.443;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;223;1154.142,1893.527;Inherit;False;1192.335;607.3147;HeightCombine;14;209;210;211;212;213;214;215;216;217;218;219;220;221;222;HeightCombine;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;209;1204.142,2094.549;Inherit;False;112;BlendWeight;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;212;1628.493,2201.555;Inherit;False;44;Layer3_Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;210;1631.524,2315.042;Inherit;False;171;Layer4_Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;211;1389.493,2096.554;Inherit;False;FLOAT4;1;0;FLOAT4;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.GetLocalVarNode;213;1630.197,1943.527;Inherit;False;13;Layer1_Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;214;1631.077,2067.719;Inherit;False;35;Layer2_Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;216;1859.493,2236.555;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;235;-279.1418,3817.395;Inherit;False;1517.94;437.2183;Slope;10;224;225;226;227;229;234;228;233;232;230;Slope;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;215;1867.524,2367.042;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;224;-186.9009,3867.395;Inherit;False;Constant;_Vector0;Vector 0;22;0;Create;True;0;0;False;0;False;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WireNode;217;1975.524,2207.042;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;220;1868.493,2000.555;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;218;1949.524,2197.042;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;219;1854.493,2104.554;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;225;-229.1418,4056.059;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;221;2004.464,2094.028;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;132;-450.1227,746.5472;Inherit;False;1480.815;538.9079;Roughness;16;130;129;123;189;125;124;188;127;128;126;187;122;131;240;239;241;Roughness;1,1,1,1;0;0
Node;AmplifyShaderEditor.DotProductOpNode;226;12.85815,3972.058;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;56;-505.05,69.18512;Inherit;False;1510.248;599.8115;BaseColor;16;54;121;120;186;119;118;49;114;179;48;117;178;115;236;237;238;BaseColor;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;229;100.8582,4111.059;Inherit;False;Property;_AutoSlopeRange;AutoSlopeRange;22;0;Create;True;0;0;False;0;False;0;0.31;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;227;171.8582,3979.058;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;222;2121.677,2022.819;Inherit;False;HeightCombine;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;173;-1972.774,2543.088;Inherit;True;Property;_Layer4_BaseColor;Layer4_BaseColor;19;0;Create;True;0;0;False;0;False;-1;None;87c216936b76489438803719b1cd7df1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;154;-455.5864,1891.714;Inherit;False;1374.309;643.6411;Normal;17;152;151;145;146;196;197;147;195;150;149;144;148;194;153;245;246;247;Normal;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;143;-452.25,1325.649;Inherit;False;1502.117;555.8287;AO;17;141;140;134;192;193;135;139;136;138;191;190;137;133;142;242;243;244;AO;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;233;431.3891,4139.213;Inherit;False;Property;_SlopeContrast;SlopeContrast;23;0;Create;True;0;0;False;0;False;1;1.72;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;234;431.3891,3912.213;Inherit;False;222;HeightCombine;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;228;348.8582,4002.058;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;187;-11.36041,1188.009;Inherit;False;174;Layer4_Roughness;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;232;675.3891,3992.213;Inherit;False;HeightLerp;-1;;12;ea906bbd821f2a54292204fd6b053587;0;3;2;FLOAT;0;False;5;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;230;1013.998,3979.096;Inherit;False;Slope;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;240;438.7086,1079.38;Inherit;False;31;Layer2_Roughness;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;241;493.4774,1177.39;Inherit;False;230;Slope;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;247;522.2258,2352.352;Inherit;False;230;Slope;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;246;428.3093,2250.853;Inherit;False;32;Layer2_Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;243;453.4576,1642.757;Inherit;False;33;Layer2_AO;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;237;404.648,451.1335;Inherit;False;34;Layer2_BaseColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;239;709.4237,1000.538;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;244;462.7997,1727.265;Inherit;False;230;Slope;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;238;427.7376,528.7983;Inherit;False;230;Slope;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;242;667.3748,1555.015;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;245;653.2258,2173.352;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;236;699.046,377.3718;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;130;776.7811,864.9188;Inherit;False;Roughness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;152;601.949,2023.006;Inherit;False;Normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;141;784.9731,1428.842;Inherit;False;AO;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;54;652.3954,181.1514;Inherit;False;BaseColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CustomStandardSurface;1;1826.376,87.29161;Inherit;False;Metallic;Tangent;6;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,1;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.VertexColorNode;165;-537.1476,2810.455;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3218.737,3592.504;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Landscape;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=648400111F553E0A9249F66C1A6EA49CE6702386