    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                //高光反射  KK Hair
                //
                half BdotH = dot(binormalDir, normalize(viewDir + lightDir));
                half sinBH = sqrt(1 - BdotH * BdotH);
                half spec_term = max(0.0001, pow(sinBH, _SpecShinness));
                half atten = smoothstep(-1.0, 0, BdotH);
                half3 final_spec = spec_term  * _SpecIntensity * spec_color * ao * toon_diffuse1 * _SpecColor;
                ...
                return half4(final_color, i.vertex_color.a);
            }
            ENDCG
        }
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                return half4(outlineColor, i.vertex_color.a);
            }
            ENDCG
        }
    }
